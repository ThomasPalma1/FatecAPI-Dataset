...
services = pd.read_csv("C:\Desenvolvimento\MLOPS\consolidado_Servicos_categoria_id.csv", encoding="utf-8",sep=";",on_bad_lines='skip')
#Importação dos dados referentes às notas de serviços de bancos
ratings = pd.read_csv("C:\Desenvolvimento\MLOPS\service_ratings_category.csv", sep=";" , encoding="latin-1",on_bad_lines='skip')
